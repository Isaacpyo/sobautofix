...
export function ServiceCategoryNavigation({ current }: { current?: ServiceCategoryKey }) {
  return (
    <section className="border-y border-[#E4EAF0] bg-white py-6" aria-labelledby="service-categories-heading">
      <Container>
        <Eyebrow>Explore our services</Eyebrow>
        <h2 id="service-categories-heading" className="sr-only">Service categories</h2>
        <nav aria-label="Service categories" className="grid gap-3 md:grid-cols-3">
...
export function CategoryFaqs({ faqs, eyebrow = "Questions about this service category" }: { faqs: CategoryFaq[]; eyebrow?: string }) {
  return (
