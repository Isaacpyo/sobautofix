  ...
  return (
    <>
      <form action={action} className="mt-7 grid gap-5">
        ...
        <label className="flex items-start gap-3 rounded-xl border border-[#D7E0E9] bg-[#F8FAFC] p-4 text-sm leading-5 text-[#344256]">
          <input type="checkbox" name="trustDevice" value="yes" className="mt-0.5 size-4 accent-[#1974E2]" />
          <span><strong className="block text-[#071127]">Trust this device for 7 days</strong>Only select this on a private browser you control.</span>
        </label>
