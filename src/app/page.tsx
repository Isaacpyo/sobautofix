  ...
  return (
    <>
      ...
      <section className="hero-grid relative overflow-hidden py-16 text-white sm:py-20 lg:py-28">
        <Image src={heroImage} alt="" fill priority sizes="100vw" className="object-cover object-center opacity-90" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#071127]/70 via-[#071127]/35 to-transparent" />
...
function Feature({ icon, title }: { icon: React.ReactNode; title: string }) {
  return <div className="rounded-2xl border border-[#D7E0E9] bg-[#F8FAFC] p-5"><span className="text-[#168BFF]">{icon}</span><strong className="mt-8 block text-lg text-[#071127]">{title}</strong></div>;
}
