...
export default async function NewArticlePage() {
  ...
  return <><p className="text-xs font-extrabold tracking-widest text-[#1974E2] uppercase">News &amp; Blog</p><h1 className="mb-8 mt-2 text-4xl font-extrabold text-[#071127]">New article</h1><ContentEditor articleMode media={media} action={saveContent} coverUploadAction={uploadArticleCover} /></>;
}
