...
export default function BookPage() {
  return <><PageHero eyebrow="Online booking" title="Book your appointment" body="Your selected vehicle, problem and service stay with this tab and are passed into the booking flow where supported." cta={false} /><section className="py-12 sm:py-16"><Container className="max-w-5xl"><div className="mb-7"><VehicleSummary /></div><CalendlyEmbed /><p className="mt-5 text-center text-sm text-[#667586]">The calendar shows the appointment options currently available online.</p></Container></section></>;
}
