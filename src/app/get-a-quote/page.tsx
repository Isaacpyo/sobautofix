...
export default function QuotePage() {
  return <><PageHero eyebrow="Request an estimate" title="Start with the vehicle and the problem." cta={false} showTrustFacts={false}><VehicleJourney compact source="quote" /></PageHero><section className="bg-[#F4F7FA] py-20" data-motion="off"><Container className="max-w-3xl"><EnquiryForm type="repair" title="Request an estimate" /></Container></section></>;
}
